...
async function processPhase(htmlPath: string, resultPath: string, reportPath: string, phaseName: string) {
...
if (args.length === 4) {
    ...
    console.log("Usage: npx tsx scripts/process_kanto_phase.ts <htmlPath> <resultPath> <reportPath> <phaseName>");
}
