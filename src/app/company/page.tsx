...
const companyFaqs = [
  {
    ...
    answer: "神奈川県横浜市戸塚区戸塚町4170 高橋ビル1階に本社を置いております。各線戸塚駅から徒歩約7分です。ご相談や現地調査は全国対応で行っております。",
  },
  {
    question: "株式会社清蓮の設立はいつですか？",
    answer: "2008年8月6日に設立しました。代表取締役の眞如理恵が「お墓じまい」「改葬」や「海洋散骨」の専門会社として立ち上げ、法令遵守と誠実な対話を理念に全国対応を続けています。",
  },
  {
    question: "行政書士や石材店とのネットワークはありますか？",
    answer: "はい、全国の優良な石材店や、改葬手続きに強い行政書士、弁護士など専門家との強力なネットワークを構築しております。お客様の状況に合わせて最適な専門家を手配・ご紹介可能です。",
  },
  {
    question: "お墓じまいの相談は本当に無料ですか？",
    answer: "はい、初回のご相談や現地調査、お見積りの作成まではすべて無料で行っております。お電話・メール・LINEいずれからでもご相談可能です。しつこい営業や訪問販売は一切行っておりません。",
  },
  {
    question: "全国どこでも対応してくれますか？",
    answer: "はい、北海道から沖縄まで全国対応しております。遠方でなかなか現地へ行けないお客様に代わって、弊社スタッフが現地へ赴き、写真や動画で状況をご報告しながら手続きや工事を進めることも可能です。",
  },
  {
    question: "費用が安すぎて（または高すぎて）不安です。追加請求はありませんか？",
    answer: "弊社では、現地調査を行ったうえで「確定見積り」をご提示しており、原則として事後に追加費用を請求することは一切ありません。見積もりの内訳もすべて明示し、ご納得いただいたうえでご契約となります。",
  },
  {
    question: "海洋散骨の実績はどのくらいありますか？",
    answer: "自社で「散骨クルーズ」という専門サービスを運営しており、東京湾や相模湾をはじめ、全国各地での海洋散骨の実績が多数ございます。お墓じまい後のご遺骨の行き先として、責任を持ってサポートいたします。",
  },
  {
    question: "途中で担当者が変わることはありますか？",
    answer: "ご相談から現地調査、お見積り、実際の工事手配、ご遺骨のケアまで、基本的にお客様専任の担当者が一貫してサポートいたします。たらい回しにされる心配はございません。",
  },
]
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="py-20 bg-white">
          <div className="mx-auto max-w-4xl px-6 text-center">
            ...
            <h1 className="mt-6 text-xl font-semibold tracking-tight leading-[1.15] text-neutral-900 md:text-3xl lg:text-4xl">
              供養を、誠実に。
            </h1>
