        ...
        <div className="bg-white">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-6">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-neutral-700 max-w-[54ch]">
                    改葬は、申請書の手続きだけでなく、墓地管理者との確認、墓石撤去、閉眼供養、遺骨の取り出し、粉骨・洗骨、次の供養先選びまで関係します。清蓮では、お墓じまい全体の流れを整理し、ご状況に合わせた進め方をご案内します。
                  </p>
                  <Link
                    href="/contact"
                    className="mt-5 inline-flex items-center gap-2 rounded-full bg-emerald-600 px-6 py-3 text-sm font-semibold text-white hover:bg-emerald-700 transition-colors"
                  >
                    清蓮にお墓じまいを無料相談する
                ...
                <div className="rounded-xl border bg-slate-50 p-6 text-center">
                  <h2 className="text-lg font-bold text-neutral-900">改葬許可申請の書類作成に不安がある方は行政書士に相談できます</h2>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground max-w-[48ch] mx-auto">
                    改葬許可申請書の書類作成・提出代行は行政書士が行える業務です。お墓じまいナビでは全国の提携行政書士をご紹介しています。
                  </p>
                  <Link
                    href="/gyoseishoshi"
