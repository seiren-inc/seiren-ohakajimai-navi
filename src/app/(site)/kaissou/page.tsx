            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-6 text-center">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground max-w-[52ch] mx-auto">
                    改葬許可申請の手続きだけでなく、墓石撤去・閉眼供養・遺骨の取り出し・粉骨・洗骨・次の供養先選びまで、お墓じまい全体を清蓮がご案内します。横浜を拠点に全国対応。現地調査・見積もりは無料です。
                  </p>
                  <Link
                    href="/contact"
                  ...
                  <p className="mt-3 text-xs text-muted-foreground">相談・見積もりは無料。強引な勧誘はしません。</p>
                </div>

                {/* 行政書士紹介CTA（補助導線） */}
                <div className="rounded-xl border bg-slate-50 p-6 text-center">
                  <h2 className="text-lg font-bold text-neutral-900">手続き書類に不安がある方は行政書士に相談できます</h2>
