        ...
        <div className="bg-white">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-6 text-center">
                  <h2 className="text-lg font-bold text-neutral-900">お墓じまい全体をまとめて相談したい方へ</h2>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground max-w-[48ch] mx-auto">
                    改葬許可申請の手続きだけでなく、墓石撤去・閉眼供養・遺骨の取り出し・粉骨・洗骨・次の供養先選びまで、株式会社清蓮にまとめてご相談いただけます。見積もり・現地調査は無料です。
                  </p>
                  <Link
                    href="/contact"
                  ...
                  <p className="mt-3 text-xs text-muted-foreground">見積もり・現地調査は無料。強引な勧誘はしません。</p>
                </div>

                {/* 行政書士紹介CTA — 書類作成・申請代行の補助導線 */}
                <div className="rounded-xl border bg-slate-50 p-6 text-center">
                  <h2 className="text-lg font-bold text-neutral-900">手続き書類の作成・代行は行政書士へ</h2>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground max-w-[48ch] mx-auto">
