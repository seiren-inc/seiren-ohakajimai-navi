        ...
        <div className="bg-white">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="rounded-xl border border-emerald-100 bg-emerald-50 p-6 text-center">
                  <h2 className="text-lg font-bold text-emerald-900">お墓じまい・改葬で迷ったら清蓮へご相談ください</h2>
                  <p className="mt-2 text-sm leading-relaxed text-emerald-800 max-w-[52ch] mx-auto">
                    改葬手続きだけでなく、墓石撤去・閉眼供養・遺骨の取り出し・粉骨・洗骨・次の納骨先選びまで、お墓じまい全体を整理してご案内します。
                  </p>
                  <Link
                    href="/contact"
