        ...
        <div className="bg-white">
            ...
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <div className="rounded-xl border bg-emerald-50 p-6 text-center">
                  <h2 className="text-lg font-bold text-neutral-900">お墓じまい全体を清蓮にご相談ください</h2>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground max-w-[48ch] mx-auto">
                    改葬手続きだけでなく、墓石撤去・閉眼供養・遺骨の取り出し・粉骨・洗骨・次の納骨先選びまで、お墓じまい全体をまとめて相談できます。横浜市を拠点に全国対応。現地調査・見積もりは無料です。
                  </p>
                  <Link
                    href="/contact"
                  ...
                  <p className="mt-3 text-xs text-muted-foreground">相談・見積もり無料。強引な勧誘はしません。</p>
                </div>

                {/* 行政書士紹介CTA（補助導線） */}
                <div className="rounded-xl border bg-slate-50 p-6 text-center">
                  <h2 className="text-lg font-bold text-neutral-900">書類作成・申請代行に不安がある方は行政書士に相談できます</h2>
                  <p className="mt-2 text-sm leading-relaxed text-muted-foreground max-w-[48ch] mx-auto">
