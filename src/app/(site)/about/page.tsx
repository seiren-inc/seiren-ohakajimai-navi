...
const aboutFaqs = [
  ...
  },
  {
    ...
    answer: '墓石の撤去工事は石材店に依頼します。株式会社清蓮では全国の優良提携石材店と連携し、現地状況に合わせた墓石撤去工事を手配します。関東地方から沖縄まで全国対応で、現地調査は無料で行います。',
  },
  {
  ...
  },
  {
    ...
    answer: '一般的に2〜4ヶ月程度が目安です。改葬許可証の発行期間（市区町村により数日〜2週間）、墓石撤去工事の日程調整、寺院・霊園との調整などが含まれます。墓地の立地や自治体の対応速度によって大きく左右されます。お急ぎの場合は個別にご相談ください。',
  },
  {
...
export const metadata = constructMetadata({
  title: "お墓じまいとは｜改葬との違い・費用・手続き・供養先を解説",
  description:
    "お墓じまいとは、墓石撤去と遺骨の移動を含む一連の手続きです。改葬との違い、費用、必要書類、供養先の選び方を清蓮が解説します。",
  path: '/about',
})
          ...
          <section>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              {[
                ...
                {
                  title: "離檀（りだん）と離檀料",
                  body: "離檀とは、これまで檀家として所属していた寺院から離れることです。改葬に際し、寺院側から「離檀料」を求められるケースがあります。法的な義務はなく、金額や進め方に不安がある場合は、状況を整理したうえで、必要に応じて適切な専門家への相談も検討してください。清蓮では寺院への連絡・説明内容の整理サポートを行っています。",
                },
                {
                  title: "改葬後の供養方法",
