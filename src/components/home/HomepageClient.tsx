...
const testimonials = [
  {
    ...
    situation: "寺院墓地からの改葬",
    rating: 5,
    text: "離檀料の交渉をどうすれば良いか途方に暮れていましたが、清蓮さんにご相談してスムーズに進めることができました。行政書士の先生もすぐにご紹介いただき、書類の準備も安心でした。",
    name: "S.K様（60代）",
  },
  {
    prefecture: "大阪府",
    situation: "公営墓地からの改葬・散骨",
    rating: 5,
    text: "他のお墓じまい業者は追加費用が多くて不信感がありましたが、こちらは見積り通りの金額で完了しました。墓石の撤去から遺骨のケアまで一括でお願いできたので本当に助かりました。",
    name: "T.M様（50代）",
  },
  {
    prefecture: "神奈川県",
    situation: "遠方のお墓を永代供養に変更",
    rating: 5,
    text: "父方の墓が地方にあり、管理が続けられなくなって相談しました。現地調査から手続きまで全部やっていただき、私は書類に捺印するだけで済みました。遠方でも任せられると思います。",
    name: "Y.N様（40代）",
  },
  {
    prefecture: "愛知県",
    situation: "お墓じまいと海洋散骨",
    rating: 5,
    text: "母の遺骨を海に散骨したいという父の強い希望がありました。改葬許可証の取得から散骨まで一貫してサポートしていただき、家族全員が納得した形でお見送りできました。",
    name: "A.K様（50代）",
  },
]
    ...
    <>
      ...
      <div className="flex flex-col min-h-screen text-neutral-900 selection:bg-emerald-100 selection:text-emerald-900 pb-20 md:pb-0">
            ...
            >
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <a
                  ...
                  className="inline-flex min-h-[54px] items-center justify-center gap-2 rounded-full border-2 border-gray-200 bg-white/80 px-8 text-[17px] font-semibold text-neutral-900 backdrop-blur transition-all hover:border-gray-300 hover:bg-white"
                >
              ...
              <p className="mt-5 text-[13px] font-medium text-neutral-600">24時間365日受付 / お見積り無料 / 無理な勧誘なし</p>
            </div>
          </div>
        </section>
            ...
            {trustStats.map((item) => (
              <div key={item.label} className="flex flex-col items-center px-8 py-10 text-center">
                <div className="flex items-baseline gap-1">
                  ...
                  <span className="text-[15px] font-medium text-neutral-500">{item.unit}</span>
                </div>
                <p className="mt-2 text-[13px] font-medium text-neutral-400">{item.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <Reveal className="py-24 md:py-36">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-[22px] font-bold tracking-tight text-neutral-900 md:text-[34px] lg:text-[44px]">選ばれる3つの理由</h2>
            ...
            <div className="mt-16 space-y-20 md:mt-20 md:space-y-28">
              ...
              <div className="flex flex-col items-center gap-10 md:flex-row md:gap-16">
                ...
                <div className="min-w-0 w-full md:w-1/2">
                  ...
                  <h3 className="typography-heading mt-3 max-w-[22ch] text-xl font-semibold leading-[1.2] tracking-tight text-neutral-900 md:text-2xl lg:text-3xl">全国対応と提携ネットワーク</h3>
              ...
              <div className="flex flex-col items-center gap-10 md:flex-row-reverse md:gap-16">
                ...
                <div className="min-w-0 w-full md:w-1/2">
                  ...
                  <h3 className="typography-heading mt-3 max-w-[22ch] text-xl font-semibold leading-[1.2] tracking-tight text-neutral-900 md:text-2xl lg:text-3xl">法令遵守の安心設計</h3>
              ...
              <div className="flex flex-col items-center gap-10 md:flex-row md:gap-16">
                ...
                <div className="min-w-0 w-full md:w-1/2">
                  ...
                  <h3 className="typography-heading mt-3 max-w-[22ch] text-xl font-semibold leading-[1.2] tracking-tight text-neutral-900 md:text-2xl lg:text-3xl">離檀交渉サポート</h3>
        ...
        <Reveal className="bg-neutral-50 py-24 md:py-36">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-[22px] font-bold tracking-tight text-neutral-900 md:text-[34px] lg:text-[44px]">サービス内容</h2>
        ...
        <Reveal id="kaisou-steps" className="py-24 md:py-36">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-[22px] font-bold tracking-tight text-neutral-900 md:text-[34px] lg:text-[44px]">改葬手続きとは</h2>
            ...
            <div className="mx-auto mt-10 flex max-w-2xl items-start gap-3 rounded-2xl bg-neutral-50 px-6 py-4">
        ...
        <Reveal className="bg-neutral-50 py-24 md:py-36">
          <div className="mx-auto max-w-5xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-[22px] font-bold tracking-tight text-neutral-900 md:text-[34px] lg:text-[44px]">私たちの対応範囲</h2>
            ...
            <div className="mt-16 grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-3xl bg-white p-8 md:p-10 shadow-sm">
                ...
                <h3 className="mt-5 text-xl font-bold text-neutral-900">清蓮ができること</h3>
              ...
              <div className="rounded-3xl border-2 border-amber-200 bg-amber-50/30 p-8 md:p-10">
                ...
                <h3 className="mt-5 text-xl font-bold text-neutral-900">清蓮が行わないこと</h3>
        ...
        <Reveal id="flow" className="py-24 md:py-36">
          <div className="mx-auto max-w-4xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-[22px] font-bold tracking-tight text-neutral-900 md:text-[34px] lg:text-[44px]">ご依頼の流れ</h2>
                ...
                <div key={item.step} className="relative flex gap-6 pb-12 last:pb-0">
                  ...
                  <div className="flex-1 pt-1">
                    <div className="flex items-center gap-3">
                      <h3 className="text-[19px] font-semibold text-neutral-900">{item.title}</h3>
                      {item.badge && (
        ...
        {/* ============================================================
            [I] 料金について
        ============================================================ */}
        <Reveal id="pricing" className="bg-neutral-50 py-24 md:py-36">
          <div className="mx-auto max-w-4xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-[22px] font-bold tracking-tight text-neutral-900 md:text-[34px] lg:text-[44px]">料金について</h2>
            ...
            <div className="mt-12 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div key={item.title} className="flex flex-col items-center rounded-2xl bg-white p-8 text-center shadow-sm">
                  ...
                  <h3 className="mt-4 text-[17px] font-semibold text-neutral-900">{item.title}</h3>
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-emerald-50 via-white to-gray-50 p-10 md:p-20">
              <div className="relative z-10 mx-auto max-w-2xl text-center">
                <h2 className="text-balance text-[28px] font-bold tracking-tight text-neutral-900 md:text-[36px]">ご自分で手続きされる方へ</h2>
        ...
        <Reveal className="py-24 md:py-36">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-balance text-[22px] font-bold tracking-tight text-neutral-900 md:text-[34px] lg:text-[44px]">お客様の声</h2>
              <p className="mt-5 text-[17px] leading-[1.65] text-neutral-500">実際にご依頼いただいたお客様からいただいた声です。</p>
            </div>
            <div className="mt-16 grid gap-6 md:grid-cols-2">
              {testimonials.map((t, i) => (
                <div key={i} className="flex flex-col rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
                  ...
                  <p className="mt-5 flex-1 text-[15px] leading-[1.8] text-neutral-600">「{t.text}」</p>
                  <p className="mt-5 text-sm font-semibold text-neutral-500">{t.name}</p>
                </div>
              ))}
            </div>
            <p className="mt-8 text-center text-xs text-neutral-400">※ 個人情報保護のため、一部内容を省略・修正しています。</p>
          </div>
        </Reveal>
        ...
        <Reveal className="bg-neutral-50 py-24 md:py-36">
          <div className="mx-auto max-w-3xl px-6">
            <div className="text-center">
              <h2 className="text-balance text-[34px] font-bold tracking-tight text-neutral-900 md:text-[44px]">よくあるご質問</h2>
            </div>
            ...
            <div className="mt-14 divide-y divide-gray-200">
              {faqs.map((faq, i) => (
                <details key={i} className="group">
                  ...
                  <p className="pb-7 pr-10 text-[16px] leading-[1.7] text-neutral-500">{faq.a}</p>
                </details>
              ))}
            </div>
          </div>
